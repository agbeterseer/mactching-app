                                        ...
                                        <div class="portlet light form-fit bordered">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    ...
                                                    <span class="caption-subject font-green sbold uppercase">Upload MDA Monthly Payment Report</span>
                                                </div> 
                                            </div>
                                            <div class="portlet-body form">
                                                <!-- BEGIN FORM-->
                                                <form method='post' action="{{ route('upload.reg_list2') }}" class="form-horizontal form-bordered" enctype='multipart/form-data' >
                                                {{ csrf_field() }}
                                                <input type="hidden" value="{{$mda_id}}" name="mda_id"/>
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3">Payment Report List</label>
                                                            <div class="col-md-3">
