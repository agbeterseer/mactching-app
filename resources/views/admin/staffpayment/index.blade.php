                                        ...
                                        <div class="portlet light portlet-fit bordered">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    ...
                                                    <a href="{{ route('staffpayment.create') }}" class="btn btn-primary">Add MDA Payment List</a>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12"> 
                                                            <div class="mt-card-item">
                                                                <div class="mt-card-avatar mt-overlay-1">
                                                                    ...
                                                                    <div class="mt-overlay">
                                                                        <ul class="mt-info">
                                                                            ...
                                                                            <li>
                                                                            <form action="{{route('staffpayment.destroy', $data->mda)}}" method="POST">
                                                                                {{csrf_field()}}
                                                                                {{method_field('DELETE')}}
                                                                ...
                                                                <div class="mt-card-content">
                                                                    ...
                                                                    <a href="{{route('upload_form2', array('mda_id'=>$data->mda))}}" class="btn btn-success">Match Monthly Report</a>  
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
