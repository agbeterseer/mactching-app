...
class CreateStaffPaymentReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('staff_payment_reports', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('staff_payment_reports');
    }
}
